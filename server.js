...
const credentials = require('./credentials.json'); // tu JSON de Google Service Account
...
app.post('/api/register', async (req, res) => {
  try {
    ...
    await sheetsClient.spreadsheets.values.append({
      ...
      resource: {
        values: [[nombre, matricula || '', actividad, sala, fecha, hora_entrada]],
      },
    });
